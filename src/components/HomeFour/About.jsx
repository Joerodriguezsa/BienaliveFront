...
import AboutImage1 from '../../assets/images/about/about-four-shape.png';
import AboutImage2 from '../../assets/images/about/about-four-image1.jpg';
import AboutImage3 from '../../assets/images/about/about-four-image2.jpg';

function About({ className }) {
    return (
        <section id="about" className={`about-section-four pb-130 ${className || ''}`}>
                ...
                <div className="row g-4">
                    <div className="col-lg-5 left-column">
                        <div className="inner-column mt-80">
                            ...
                            <div className="image"><img src={AboutImage2} alt="image"/></div>
                        </div>
                    </div>
                    <div className="col-lg-7 right-column">
                        <div className="inner-column">
                            ...
                            <div className="content-box mt-80">
                                <h3 className="wow fadeInDown" data-wow-delay="00ms" data-wow-duration="1500ms">Benefits of
