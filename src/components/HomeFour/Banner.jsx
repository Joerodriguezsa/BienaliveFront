...
import BannerShapeImage1 from '../../assets/images/shape/banner-four-shape1.png';
import BannerShapeImage2 from '../../assets/images/shape/banner-four-shape2.png';
import BannerBgImage from '../../assets/images/banner/banner-four-image.jpg';
import BannerImage1 from '../../assets/images/product/baner-broduct1.png';
import BannerImage2 from '../../assets/images/product/baner-broduct2.png';
import BannerImage3 from '../../assets/images/product/baner-broduct3.png';
...
function BannerSection() {
    ...
    return (
        <section className="banner-four-area">
            ...
            <div className="banner-four__shape-two">
                <img className="animation__floatBob" src={BannerShapeImage2} alt="image"/>
            </div>
            <div className="banner-four__wrp">
                ...
                <div className="banner-four__content">
                    ...
                    <Link to="/page-contact" className="btn-two wow fadeInUp mt-50" data-wow-delay="1s">Book Now
                ...
                <Swiper {...swiperOptions} className="swiper banner-four__slider">
                    <SwiperSlide className="swiper-slide">
                        <div className="item">
                            ...
                            <div className="image"><img src={BannerImage1} alt="image"/></div>
                            <div className="content">
                                <h4 className="price">$60.00</h4>
                                <h3 className="title"><Link to="/shop-product">Glow Facial Cream</Link></h3>
                            </div>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                        <div className="item">
                            ...
                            <div className="image"><img src={BannerImage2} alt="image"/></div>
                            <div className="content">
                                <h4 className="price">$60.00</h4>
                                <h3 className="title"><Link to="/shop-product">Glow Facial Cream</Link></h3>
                            </div>
                    ...
                    <SwiperSlide className="swiper-slide">
                        <div className="item">
                            <div className="new-tag">New</div>
                            <div className="image"><img src={BannerImage3} alt="image"/></div>
                            <div className="content">
                                <h4 className="price">$60.00</h4>
                                <h3 className="title"><Link to="/shop-product">Glow Facial Cream</Link></h3>
                            </div>
