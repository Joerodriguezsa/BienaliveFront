...
import FunfactImage1 from '../../assets/images/funfact/funfact-image.jpg';
    ...
    return (
        <section className="funfact-section-four">
            <div className="outer-box">
                ...
                <div className="image-box" style={{ backgroundImage: `url(${FunfactImage1})` }}>
                    <div className="section-header center">
                        ...
                        <Link to="/page-contact" className="btn-two mt-50 wow text-font fadeInUp" data-wow-delay="400ms"
