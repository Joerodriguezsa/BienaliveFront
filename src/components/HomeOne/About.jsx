...
import AboutImage1 from '../../assets/images/about/about-image.png';
import AboutImage2 from '../../assets/images/shape/about-left-shape.png';
import AboutImage3 from '../../assets/images/shape/about-right-shape.png';

function About({ className }) {
    return (
        <section id="about" className={`about-section pt-130 pb-100 ${className || ''}`}>
            ...
            <div className="shape2 wow slideInRight" data-wow-delay="400ms" data-wow-duration="1500ms">
                <img className="sway_Y__animation" src={AboutImage3} alt="image"/>
            </div>
                ...
                <div className="row g-4">
                    <div className="col-lg-7 content-column">
                        <div className="inner-column">
                            ...
                            <Link to="/page-about" className="btn-one mt-30 wow fadeInDown" data-wow-delay="400ms"
