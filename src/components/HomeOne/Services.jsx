...
import ServiceImage1 from '../../assets/images/shape/service-shape-left.png';
import ServiceImage2 from '../../assets/images/shape/service-shape-right.png';
    ...
    return (
        <section id="services" className="service-section section__decoration-top  section__decoration-bottom bg-sub pt-130 pb-130">
            <div className="shape1 wow slideInLeft">
                <img className="sway__animation" src={ServiceImage1} alt="imag"/>
            </div>
            <div className="shape2">
                <img className="animation__arryUpDown" src={ServiceImage2} alt="imag"/>
            </div>
            <div className="container">
                ...
                <div className="row g-5">
                    ...
                    {!loading && services.map(service => (
                        <div key={service.id} className="col-lg-3 service-block col-md-6 wow fadeInDown" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div className="inner-box">
                                <div className="icon-box">
                                    <img
                                        src={
                                            service.serviceImages
                                            ?.find(img => img.tipoImagenId === 1)
                                            ?.imageUrl
                                        }
                                        alt={service.name}
                                        style={{
                                ...
                                <h4 className="title"><Link to={`/services/${service.id}`}>{service.name}</Link></h4>
                                <p className="text">
