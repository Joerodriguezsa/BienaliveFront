...
function Services() {
  ...
  return (
    <section
      id="services"
      className="service-section section__decoration-top  section__decoration-bottom bg-sub pt-130 pb-130"
    >
        ...
        <div className="row g-5">
          ...
          {!loading &&
            services.map((service) => (
              <div
                key={service.id}
                className="col-lg-3 service-block col-md-6 wow fadeInDown"
                data-wow-delay="00ms"
                data-wow-duration="1500ms"
              >
