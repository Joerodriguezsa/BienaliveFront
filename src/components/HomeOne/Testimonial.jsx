...
import TestimonialsShapeImage from '../../assets/images/shape/testimonial-shape.png';
import TestimonialsImage1 from '../../assets/images/testimonial/testimonial-image1.png';
import TestimonialsImage2 from '../../assets/images/testimonial/testimonial-image2.png';
import TestimonialsImage3 from '../../assets/images/testimonial/testimonial-image3.png';
...
function Testimonial() {
    return (
        <section className="testimonial-section pt-130 pb-130">
            <div className="shape">
                <img className="animation__arryUpDown" src={TestimonialsShapeImage} alt="image"/>
            </div>
            <div className="container">
                <div className="section-header__flex mb-60">
                    <div>
                        ...
                        <h2 className="title wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">What Our Client
                            Says</h2>
                    </div>
                    <div className="slider-arrys wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <button className="testimonial-arry-prev"><i className="fa-light fa-arrow-left"></i></button>
                        <button className="testimonial-arry-next"><i className="fa-light fa-arrow-right"></i></button>
                    </div>
                </div>
                <Swiper {...swiperOptions} className="swiper testimonial-slider">
                        <SwiperSlide className="swiper-slide testimonial-block">
                            <div className="inner-box">
                                ...
                                <div className="content-box">
                                    ...
                                    <p>“ Suspendisse sit amet neque euismod, convallis quam eget, dignissim massa.
                                        Aliquam
                                        blandit risus purus, in congue”</p>
                                    <div className="star">
