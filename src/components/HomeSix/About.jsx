...
import AboutShapeImage1 from '../../assets/images/shape/about-six-shape.png';
import AboutImage1 from '../../assets/images/about/about-six-image1.jpg';
import AboutImage2 from '../../assets/images/about/about-six-image2.jpg';
...
function About() {
    return (
        <section id="about" className="about-section-six">
            <div className="shape">
                <img className="animation__floatBob" src={AboutShapeImage1} alt="image"/>
            </div>
                    ...
                    <div className="col-lg-6 right-column">
                        <div className="inner-column">
                            <div className="section-header">
                                ...
                                <h2 className="title wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">New
                                    solutions with organic oil free products</h2>
                                <p className="text wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">Proin
                            ...
                            <Link to="/page-about" className="btn-two mt-30 wow fadeInDown" data-wow-delay="400ms"
