...
import BannerImage1 from '../../assets/images/shape/banner-six-shape.png';
import BannerImage2 from '../../assets/images/shape/banner-six-shape2.png';
import BannerImage3 from '../../assets/images/shape/banner-six-shape3.png';
import BannerImage4 from '../../assets/images/banner/banner-six-image.png';
import BannerImage5 from '../../assets/images/banner/banner-six-image-bg.png';


function BannerSection() {
    return (
        <section className="banner-six-area paralax__animation" style={{ backgroundImage: `url(${BannerBgImage1})` }}>
            ...
            <div className="banner-six__shape-two">
                <img className="animation__floatBob" src={BannerImage2} alt="image"/>
            </div>
            <div className="banner-six__shape-three">
                <img className="animation__arryLeftRight" src={BannerImage3} alt="image"/>
            </div>
            ...
            <div className="container">
                <div className="banner-six__content">
                    ...
                    <h1 className="title wow fadeInDown" data-wow-delay="500ms"><span>Where Comfort</span>
                        Meets Luxury</h1>
                    <p className="text wow fadeInDown" data-wow-delay="700ms">Proin efficitur, mauris vel condimentum
                        pulvinar, velit orci consectetur ligula,
                        eget egestas
                        magna mi ut arcu.
                        Phasellus nec odio orci. Nunc id massa ante. Suspendisse sit amet neque euismod, convallis quam
                        eget,</p>
                    <Link to="/page-contact" className="btn-two-dark wow fadeInDown mt-50" data-wow-delay="1s">Book Now
            ...
            <div className="banner-six__image-bg wow bounceInRight" data-wow-delay="700ms"
                ...
                <img data-depth="0.03" src={BannerImage5} alt="image"/>
            </div>
        </section>
    );
}
