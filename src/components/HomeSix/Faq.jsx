...
import FaqImage from '../../assets/images/faq/faq-image.jpg';
import FaqShapeImage from '../../assets/images/faq/shape.png';
                ...
                <div className="row g-4">
                    ...
                    <div className="col-xxl-6 content-column">
                        <div className="inner-column">
                            ...
                            <div className="shape">
                                <img className="bobble__animation" src={FaqShapeImage} alt="image"/>
                            </div>
                        </div>
                    </div>
                </div>
