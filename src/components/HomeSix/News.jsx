...
import NewsImage1 from '../../assets/images/blog/blog-two-image1.jpg';
import NewsImage2 from '../../assets/images/blog/blog-two-image2.jpg';
import NewsImage3 from '../../assets/images/blog/blog-two-image3.jpg';


function News({ className }) {
    return (
        <section id="news" className={`blog-section-two pt-130 pb-130 ${className || ''}`}>
            <div className="container">
                ...
                <div className="row g-4">
                    <div className="col-md-6 col-xl-4 blog-block-two wow fadeInLeft" data-wow-delay="00ms"
                    ...
                    <div className="col-md-6 col-xl-4 blog-block-two wow fadeInLeft" data-wow-delay="200ms"
                        data-wow-duration="1500ms">
                        <div className="inner-box">
                            <div className="image">
                            ...
                            <div className="content">
                                <h6 className="info"><span>Admin</span><span className="dot">Body, Treatment</span></h6>
                                <h4 className="title"><Link to="/news-details">We giving Amazing special spa and message
                                        service for vip.</Link></h4>
                                <p>Suspendisse sit amet neque euismod, convallis quam eget, dignissim massa. Aliquam
                                    blandit.</p>
                                <Link className="readMore-btn" to="/news-details">Read More</Link>
                            </div>
                    ...
                    <div className="col-md-6 col-xl-4 blog-block-two wow fadeInLeft" data-wow-delay="400ms"
                        data-wow-duration="1500ms">
                        <div className="inner-box">
                            <div className="image">
