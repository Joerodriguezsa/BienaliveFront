...
function Portfolio() {
    ...
    const swiperOptions = {
        ...
        loop: true,
        navigation: {
            nextEl: '.gallery-arry-prev-two',
            prevEl: '.gallery-arry-next-two',
        },
        breakpoints: {
            320: {
                slidesPerView: 1,
    ...
    return (
        <section className="gallery-section-two pb-130">
            <div className="container-fluid px-3 px-md-4">
                <div className="section-header center mb-60">
                    ...
                    <h2 className="title wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Our Gallery</h2>
                </div>
                <Swiper {...swiperOptions} className="swiper gallery-slider-two">
                    ...
                    <button className="gallery-arry-prev-two"><i className="fa-light fa-arrow-left-long"></i></button>
                    <button className="gallery-arry-next-two"><i className="fa-light fa-arrow-right-long"></i></button>
                </Swiper>
            </div>
        </section>
    );
