...
import AboutImage1 from '../../assets/images/shape/about-three-shape.png';
import AboutImage2 from '../../assets/images/about/about-three-image1.png';
import AboutImage3 from '../../assets/images/about/about-three-image2.png';
import AboutImage4 from '../../assets/images/about/about-three-info.png';
import AboutImage5 from '../../assets/images/about/shape1.png';
import AboutImage6 from '../../assets/images/about/shape2.png';
import AboutImage7 from '../../assets/images/about/shape3.png';

function About({ className }) {
    return (
        <section id="about" className={`about-section-three pb-130 paralax__animation ${className || ''}`}>
            <div className="shape">
                <img className="animation__floatBob" src={AboutImage1} alt="image"/>
            </div>
                ...
                <div className="row g-0 align-items-center">
                    <div className="col-xl-6 image-column">
                        <div className="inner-column">
                            <div className="image">
                                <img className="image1" src={AboutImage2} alt="image"/>
                            </div>
                            <img className="image2" src={AboutImage3} alt="image"/>
                            <div className="info">
                                <img data-depth="0.01" src={AboutImage4} alt="image"/>
                            </div>
                            <div className="shape-one">
                                <img className="animation__arryUpDown" src={AboutImage5} alt="image"/>
                            </div>
                            <div className="shape-two">
                                <img data-depth="0.03" src={AboutImage6} alt="image"/>
                            </div>
                            <div className="shape-three">
                                <img className="animation__arryLeftRight" src={AboutImage7} alt="image"/>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-6 content-column">
                        <div className="inner-column">
                            ...
                            <Link to="/page-about" className="btn-three mt-40 wow fadeInDown" data-wow-delay="400ms"
