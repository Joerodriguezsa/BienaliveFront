...
import NewsShapeImage from '../../assets/images/shape/blog-shape.png';
import NewsImage4 from '../../assets/images/blog/blog-image4.jpg';
import NewsImage5 from '../../assets/images/blog/blog-image5.jpg';
import NewsImage6 from '../../assets/images/blog/blog-image6.jpg';
...
function News({ className }) {
    return (
        <section id="news" className={`blog-section pt-130 pb-130 ${className || ''}`}>
            <div className="shape">
                <img className="animation__sunMove" src={NewsShapeImage} alt="shape"/>
            </div>
            <div className="container">
                <div className="section-header mb-60 center">
                    ...
                    <h2 className="title wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">News & Articles
                    </h2>
                </div>
                <Swiper {...swiperOptions} className="swiper blog-slider">
                    <div className="swiper-wrapper">
                        <SwiperSlide className="swiper-slide blog-block">
                            <div className="inner-box">
                                <div className="image-box">
                                    <div className="image">
                                        <img src={NewsImage4} alt="imag"/>
                                    </div>
                                </div>
                                <div className="content-box">
                                    <h6 className="info"><span>Admin</span><span className="dot">Body, Treatment</span></h6>
                                    <h4 className="title"><Link to="/news-details">Spring is in the Air and So Our These
                                            Amazing Spa Offers</Link></h4>
                                    <Link className="readMore-btn" to="/news-details">Read More</Link>
                                </div>
                            </div>
                        </SwiperSlide>
                        ...
                        <SwiperSlide className="swiper-slide blog-block">
                            <div className="inner-box">
                                ...
                                <div className="content-box">
                                    <h6 className="info"><span>Admin</span><span className="dot">Body, Treatment</span></h6>
                                    <h4 className="title"><Link to="/news-details">We giving Amazing special spa and
                                            message service for vip.</Link></h4>
                                    <Link className="readMore-btn" to="/news-details">Read More</Link>
                                </div>
                            </div>
                        </SwiperSlide>
                        ...
                        <SwiperSlide className="swiper-slide blog-block">
                            <div className="inner-box">
                                <div className="image-box">
                                    <div className="image">
                                        <img src={NewsImage6} alt="imag"/>
                                    </div>
                                </div>
                                <div className="content-box">
                                    <h6 className="info"><span>Admin</span><span className="dot">Body, Treatment</span></h6>
                                    <h4 className="title"><Link to="/news-details">Looks reasonable. The generate is
                                            therefore always.</Link></h4>
                                    <Link className="readMore-btn" to="/news-details">Read More</Link>
                                </div>
                            </div>
                        </SwiperSlide>
