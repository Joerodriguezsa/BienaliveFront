...
import PricingShapeImage1 from '../../assets/images/shape/pricing-three-shape-left.png';
import PricingShapeImage2 from '../../assets/images/shape/pricing-three-shape-right.png';
import PricingImage1 from '../../assets/images/pricing/pricing-three-image1.jpg';
import PricingImage2 from '../../assets/images/pricing/pricing-three-image2.jpg';
import PricingImage3 from '../../assets/images/pricing/shape.png';

function Pricing({ className }) {
    return (


    <section className={`pricing-section-three bg-sub-two section__decoration-top section__decoration-bottom pt-130 pb-170 ${className || ''}`}>
        <div className="shape1">
            <img className="animation__arryUpDown" src={PricingShapeImage1} alt="image"/>
        </div>
        <div className="shape2">
            <img className="animation__arryLeftRight" src={PricingShapeImage2} alt="image"/>
        </div>
            ...
            <div className="outer-box mb-50">
                <div className="row g-4">
                    <div className="col-lg-8 col-xl-9 image-column">
                        <div className="image-box"> <img src={PricingImage1} alt="image"/>
                        </div>
                    </div>
                    <div className="col-lg-4 col-xl-3 pricing-block">
                        <div className="inner-box">
                            <div className="shape"> <img src={PricingImage3} alt="image"/> </div>
                            ...
                            <Link to="/page-contact" className="btn-two mt-35">Book Now
            ...
            <div className="outer-box">
                <div className="row g-4">
                    ...
                    <div className="col-lg-8 col-xl-9 image-column order-1 order-lg-2">
                        <div className="image-box"><img src={PricingImage2} alt="image"/></div>
                    </div>
                </div>
            </div>
        </div>
