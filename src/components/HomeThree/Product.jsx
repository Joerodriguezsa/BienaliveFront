...
import ProductImage5 from '../../assets/images/product/product-image5.png';
        ...
        <div className="swiper-wrapper">
            <SwiperSlide className="swiper-slide product-block-three">
                <div className="inner-box">
                    <div className="image">
                        <Link to="/shop-products"><img src={ProductImage1}
                                alt="image"/></Link>
                        <div className="info">
                            <Link to="#0">
                    ...
                    <div className="content">
                        ...
                        <h3 className="title"><Link to="/shop-products">Glow Facial Cream</Link></h3>
                    </div>
                </div>
            </SwiperSlide>
            <SwiperSlide className="swiper-slide product-block-three">
                <div className="inner-box">
                    <div className="image">
                        <Link to="/shop-products"><img src={ProductImage2}
                                alt="image"/></Link>
                        <div className="info">
                            <Link to="#0">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
            ...
            <SwiperSlide className="swiper-slide product-block-three">
                <div className="inner-box">
                    <div className="image">
                        <Link to="/shop-products"><img src={ProductImage3}
                                alt="image"/></Link>
                        <div className="info">
                            <Link to="#0">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
            ...
            <SwiperSlide className="swiper-slide product-block-three">
                <div className="inner-box">
                    <div className="image">
                        <Link to="/shop-products"><img src={ProductImage4}
                                alt="image"/></Link>
                        <div className="info">
                            <Link to="#0">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
            ...
            <SwiperSlide className="swiper-slide product-block-three">
                <div className="inner-box">
                    <div className="image">
                        <Link to="/shop-products"><img src={ProductImage5}
                                alt="image"/></Link>
                        <div className="info">
                            <Link to="#0">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
