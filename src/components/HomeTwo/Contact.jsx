...
import ContactBgImage from '../../assets/images/bg/contact-two-bg.jpg';

function Contact({ className }) {
    return (
        <section id="contact" className={`contact-section-two section__decoration-top section__decoration-bottom ${className || ''}`}
