...
import Navigation from '../SingleNavigation1.jsx';
...
function HomeTwoHeader({ className = '', scroll = false }) {
    ...
    return (
		...
		{/* <!-- Header Lower --> */}
		<div className={`header-top-area d-none d-lg-block ${className || ''}`}>
			<div className="container">
				<div className="header-top__wrp">
					<div className="header-top__links">
						<Link to="#0">alma.lawson@example.com</Link>
					</div>
				...
				<div className="header-two__wrp">
					<div className="header__main">
						...
						<div className="menu-btns">
							...
							<Link className="shop-cart" to="/shop-cart">
							...
							<Link to="/page-contact" className="book-now d-none d-xl-inline-block">Book Now
