			...
			<section id="news" className="blog-section pb-130">
				...
				<div className="container">
					<div className="section-header mb-60 center">
						...
						<h2 className="title wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">News & Articles</h2>
					</div>
						...
						<div className="swiper-wrapper">
							<SwiperSlide className="swiper-slide blog-block">
								<div className="inner-box">
									...
									<div className="content-box">
										...
										<h4 className="title"><Link to="/news-details">Spring is in the Air and So Our These Amazing Spa Offers</Link></h4>
							...
							<SwiperSlide className="swiper-slide blog-block">
								<div className="inner-box">
									...
									<div className="content-box">
										<h6 className="info"><span>Admin</span><span className="dot">Body, Treatment</span></h6>
										<h4 className="title"><Link to="/news-details">We giving Amazing special spa and message service for vip.</Link></h4>
										<Link className="readMore-btn" to="/news-details">Read More</Link>
									</div>
								</div>
							</SwiperSlide>
							<SwiperSlide className="swiper-slide blog-block">
								<div className="inner-box">
									...
									<div className="content-box">
										<h6 className="info"><span>Admin</span><span className="dot">Body, Treatment</span></h6>
										<h4 className="title"><Link to="/news-details">Looks reasonable. The generate is therefore always.</Link></h4>
										<Link className="readMore-btn" to="/news-details">Read More</Link>
									</div>
								</div>
							</SwiperSlide>
