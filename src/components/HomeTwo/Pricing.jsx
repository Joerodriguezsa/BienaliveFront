...
import PricingShapeImage1 from '../../assets/images/shape/pricing-shape.png';
import PricingShapeImage2 from '../../assets/images/pricing/shape.png';
import PricingImage1 from '../../assets/images/pricing/pricing-image.jpg';
            ...
            <div className="row g-3">
                <div className="col-xl-6 image-column">
                    <div className="inner-column gsap__parallax-zoom">
                        <img src={PricingImage1} alt="imag"/>
                    </div>
                </div>
                    ...
                    <div className="inner-column">
                        ...
                        <div className="section-header mb-60">
                            ...
                            <h2 className="title color-light wow fadeInUp" data-wow-delay="200ms"
                                data-wow-duration="1500ms">Popular Package</h2>
                        </div>
                        <div className="row g-3">
                            <div className="col-sm-6 pricing-block wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div className="inner-box transparent">
                                    <div className="shape">
                                        <img src={PricingShapeImage2} alt="image"/>
                                    </div>
                                    ...
                                    <Link to="/page-contact" className="btn-one-light mt-35">Book Now
