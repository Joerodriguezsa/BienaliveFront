...
function Product() {
    const swiperOptions = {
        ...
        loop: true,
        navigation: {
            nextEl: '.product-arry-prev',
            prevEl: '.product-arry-next',
        },
        breakpoints: {
            320: {
                slidesPerView: 1,
...
<section id="projects" className="product-section pt-130 pb-130">
<div className="container">
    <div className="section-header mb-60">
        ...
        <h2 className="title wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Chemical Free Product <br/> Collections</h2>
    </div>
    <div className="outer-box">
            ...
            <div className="swiper-wrapper">
                <SwiperSlide className="swiper-slide product-block">
                    <div className="inner-box">
                        ...
                        <div className="content">
                            ...
                            <h3 className="title"><Link to="/shop-product-details">Glow Facial Cream</Link></h3>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide className="swiper-slide product-block">
                    <div className="inner-box">
                        <div className="image">
                            <Link to="/shop-product-details"><img src={ProductImage2} alt="image"/></Link>
                            <div className="star">
                                <i className="fa-solid fa-star"></i>
                                <i className="fa-solid fa-star"></i>
                                <i className="fa-solid fa-star"></i>
                        ...
                        <div className="content">
                            <h4 className="price"><del>90$.00</del> - 70$.00</h4>
                            <h3 className="title"><Link to="/shop-product-details">Glow Facial Cream</Link></h3>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide className="swiper-slide product-block">
                    <div className="inner-box">
                        <div className="image">
                            <Link to="/shop-product-details">
                                <img src={ProductImage3} alt="image"/>
                            </Link>
                            <div className="star">
                                <i className="fa-solid fa-star"></i>
                                <i className="fa-solid fa-star"></i>
        ...
        <button className="product-arry-prev"><i className="fa-light fa-arrow-left"></i></button>
        <button className="product-arry-next"><i className="fa-light fa-arrow-right"></i></button>
    </div>
</div>
</section>
    );
