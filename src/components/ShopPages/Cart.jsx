                  ...
                  <table className="table table-striped table-bordered tbl-shopping-cart">
                    ...
                    <tbody>
                      ...
                      <tr className="cart_item">
                        ...
                        <td colSpan="2">&nbsp;</td>
                        <td><button type="button" className="theme-btn btn-style-one"><span className="btn-one mt-2">Update Cart</span></button></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div className="row">
                  <div className="col-md-5">
                    ...
                    <form className="form" action="#">
                      ...
                      <div className="mb-30">
                        <button type="button" className="theme-btn btn-style-one"><span className="btn-one mt-2">Update Totals</span></button>
                      </div>
                    </form>
                  </div>
                  ...
                  <div className="col-md-5">
                    ...
                    <Link className="theme-btn btn-style-one" href="shop-checkout"><span className="btn-one mt-2">Proceed to Checkout</span></Link>
                  </div>
                </div>
              </div>
            </div>
