    ...
    return (
        ...
        <section className="team-section pb-70 pt-120">
            <div className="container">
                ...
                <div className="col-lg-3 col-md-6 team-block mb-50">
                    <div className="inner-box">
                        <div className="image"><img src={TeamImage2} alt="image"/></div>
                        <ul className="socials">
                            <li>
                                <Link to="#0">
                                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="content">
                        <div className="shape"><img src={TeamShapeImage} alt="image"/></div>
                        <h4 className="title"><Link to="/page-team-details">Wade Warren</Link></h4>
                        <span>Spa Message</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-lg-3 col-md-6 team-block mb-50">
                    <div className="inner-box">
                        <div className="image"><img src={TeamImage4} alt="image"/></div>
                        <ul className="socials">
                            <li>
                                <Link to="#0">
                                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="content">
                        <div className="shape"><img src={TeamShapeImage} alt="image"/></div>
                        <h4 className="title"><Link to="/page-team-details">Cody Fisher</Link></h4>
                        <span>Spa Message</span>
                        </div>
                    </div>
                </div>
